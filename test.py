...
print ("Test 1 - ByteToHex - Passed: {0}".format(ByteToHex( __byteStr )))
print ("Test 2 - HexToByte - Passed: {0}".format(HexToByte( __hexStr1 )))
print ("Test 3 - HexToByte - Passed: {0}".format(HexToByte( __hexStr2 )))
